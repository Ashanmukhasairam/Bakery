...
const Analytics = () => {
  ...
  const pieData = {
    labels: ["Deliveries", "Cancelled Orders", "Pending Orders", "Total Orders"],
    datasets: [
      {
        data: [120, 5, 15, 150],
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 p-8">
        ...
        {/* Pie Chart */}
        <div className="mt-10">
          <h2 className="text-2xl font-bold text-orange-500 mb-4">Orders Breakdown</h2>
        ...
        {/* Line Chart */}
        <div className="mt-10">
          <h2 className="text-2xl font-bold text-orange-500 mb-4">Orders Over Time</h2>
